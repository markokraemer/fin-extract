...
from file_data_extraction_lite import file_data_extraction_lite
...
def main():
    parser = argparse.ArgumentParser(description="Process PDF reports and export data (Lightweight Version).")
    ...
    # Step 1: Extract data from PDFs to markdown (using lightweight PyPDF2)
    print("\n=== Step 1: Extracting data from PDFs (Lightweight Mode) ===")
    file_data_extraction_lite(reports_folder_name=reports_folder, output_folder_name=out_folder)
